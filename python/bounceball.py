...
for i in range(30):
    ...
    ball_list.append(BouncingBall( 20, 20 , random.randint(-10, 10), random.randint(-10, 10), random.randint(10, 30)))
	
# Ball = BouncingBall( x_location, y_location, x_speed, y_speed, ball_size)
# Ball2 = BouncingBall( x_location, y_location, 70, 60, ball_size)
# Ball3 = BouncingBall( x_location, y_location, 7, 6, ball_size)
# -------- Main Program Loop -----------
while not done:
    # --- Main event loop
    ...
    z=0
    for i in ball_list:
        ball_list[z].flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
        z+=1
    # Ball.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
    # Ball2.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
    # Ball3.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
